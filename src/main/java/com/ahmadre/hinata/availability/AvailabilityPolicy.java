...
public interface AvailabilityPolicy {
	...
	/**
	 * The projects [userId] recorded time on from [since] on. A lead sees somebody's absences only
	 * through one of these: membership alone is not enough, because whoever creates a project leads
	 * it and can add anybody to it.
	 */

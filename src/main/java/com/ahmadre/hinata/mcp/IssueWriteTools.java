...
public class IssueWriteTools {
	...
	public McpViews.IssueView create_issue(
			...
			@McpToolParam(required = false, description = "Priority (SHOWSTOPPER, CRITICAL, MAJOR, NORMAL, MINOR, TRIVIAL); defaults to NORMAL") Issue.Priority priority,
	...
	public McpViews.IssueView update_issue(
			...
			@McpToolParam(required = false, description = "New priority (SHOWSTOPPER, CRITICAL, MAJOR, NORMAL, MINOR, TRIVIAL)") Issue.Priority priority,
